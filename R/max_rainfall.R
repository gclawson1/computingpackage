#' max_rainfall
#'
#' compute maximum precipitation each year for a specified location during a specified month in Australia and output that year, location, month, and precipitation level.
